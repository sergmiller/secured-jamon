...
export class InsufficientFundsOnTargetChain extends Error {}
...
const ethereum = {
  ...
  send: async ({
    ...
    console.log('[derived account] Sender balance', ethers.utils.formatUnits(balance), currency);
    ...
    if (
      ...
      throw new InsufficientFundsOnTargetChain();
    }
